...
export const TeamSection = () => {
  ...
  return (
    <NewTeamSection
      ...
      description="Meet the visionary leaders driving innovation in sustainable packaging solutions. Our experienced team combines deep industry knowledge with cutting-edge technology to revolutionize food packaging for a better tomorrow."
      members={teamMembers}
